...
def config_logging(file_name="log.txt", log_level="NOSET"):
    ...
    '''
    try:
        logs_dir = os.path.join(os.getcwd(), "tool_logs")#os.path.dirname(__file__)
...
def config_logging_plus(file_name="log.txt", log_level="NOSET", remote_address=("127.0.0.1", 8888),
                        write_console=False):
    '''
