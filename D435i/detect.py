...
try:
    while True:
        ...
        #Speed optimization
        depth_ret = depth_ret[240:480,:640]
        ...
        mask = np.zeros((240,640))
        canny = np.row_stack((mask,canny))
        depth_contrast = np.row_stack((mask,depth_contrast))
...
#  except:
#    pass
#  return number_list,locate_list
#        
#  
#def pix_judment(number_list):
#  time255 = 0
#  time_med=0
#  time0 = 0
...
#    else:
#      time0 += 1
#  return time0, time_med, time255


#def show_stairs(time255,locate_list,run_time):
#  if time255 > 340:
#    print("Compute time: {} ".format(run_time))
#    print("Stairs! Danger! The location is {}".format(locate_list))
#    with open("./videodata/savefig/log.txt","a") as f:
#      f.write("Compute time: {} \ ".format(run_time))
#      f.write("Stairs! Danger! The location is {}".format(locate_list))
